...
#direccion_excel="C:\\Users\\Administrador\\Documents\\MM\\DATOS MM.xlsx"
#direccion_excel_original="/kaggle/input/error-micromedicion/DATOS MM original.xlsx"

## TENO
#direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\DATOS MM.xlsx"
#direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputMM.xlsx"


## VALPARAISO
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - VALPARAISO.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - VALPARAISO.xlsx"

## VINA DEL MAR
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - VINA DEL MAR.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - VINA DEL MAR.xlsx"

## OVALLE
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - OVALLE.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - OVALLE.xlsx"

## LOS ANDES
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - LOS ANDES.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - LOS ANDES.xlsx"

## LLAY LLAY
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - LLAY LLAY.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - LLAY LLAY.xlsx"

##LA CALERA
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - LA CALERA.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - LA CALERA.xlsx"

##ILLAPEL
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - ILLAPEL.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - ILLAPEL.xlsx"

##EL QUISCO
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - EL QUISCO.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - EL QUISCO.xlsx"

##CONCON
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - CONCON.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - CONCON.xlsx"

##CASABLANCA
# direccion_excel=f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\inputs\Datos INPUT modelo MM - CASABLANCA.xlsx"
# direccion_excel_salida = f"G:\Mi unidad\INECON\ESVAL\ErrorMicromedición\outputs\outputMM - CASABLANCA.xlsx"

##PETORCA
direccion_excel=r"C:\GitHub\Inecom_ErrorMicromedicion\ErrorMicromedición\inputs\Datos INPUT modelo MM - PETORCA 28.12.xlsx"
direccion_excel_salida = "outputMM - PETORCA.xlsx"

def mm_calc_run_alg(exceldata):
    ...
    # Calculo de error 
    E=data.merge(df_clase_grupo_decaimiento, on="Grupo", how='left').merge(caudal_ext,left_on="Clase referencia", right_on="Clase", how='left').groupby("INSTALACION").apply(lambda x: error(x,autocontrol, autocontrol_diametro_alto,  error_ultra, intervalos_caudal_bajo, intervalos_caudal_bajo_c25))
    ...
    # # Escritura del excel
    # with pd.ExcelWriter(f'output_{localidad}.xlsx') as writer:  
    #     resultados.to_excel(writer, sheet_name='Resultados loc', index=False)
    #     inicial_y_final.to_excel(writer, sheet_name='Inicial y final', index=False)
    #     data.to_excel(writer, sheet_name='BBDD - Error Actual', index=False)
