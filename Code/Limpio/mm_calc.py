...
direccion_excel=r"C:\GitHub\6020.Inecon_ModeloVanMedicion\Code\modelo MM - TALCA 28.12_v1.xlsx"
...
def mm_calc_run_alg(exceldata):
    ...
    # test=calcular_antiguedad_proximos_n_anos(pd.to_datetime("1/19/2023"),
    #                                                 fecha_estudio=fecha_estudio,
    #                                                 n=15,
    #                                                 edad_extra=edad_extra_decaimiento, 
    #                                                 edad_minima=edad_minima_decaimiento,
